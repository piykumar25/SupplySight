...
/**
 * Kafka consumer for raw tracking events from external sources.
 * Processes events from tracking.events.raw topic.
 */
@Component
public class RawEventConsumer {
    ...
    public RawEventConsumer(EventIngestionService eventIngestionService, MeterRegistry meterRegistry) {
        this.eventIngestionService = eventIngestionService;
        
        this.rawEventsReceivedCounter = Counter.builder("kafka.raw.events.received")
                .description("Number of raw events received from Kafka")
                .register(meterRegistry);
        this.rawEventsProcessedCounter = Counter.builder("kafka.raw.events.processed")
                .description("Number of raw events successfully processed")
                .register(meterRegistry);
        this.rawEventsFailedCounter = Counter.builder("kafka.raw.events.failed")
    ...
    public void consumeRawEvent(
        ...
        log.info("Received raw event: {} from partition {} offset {}", 
