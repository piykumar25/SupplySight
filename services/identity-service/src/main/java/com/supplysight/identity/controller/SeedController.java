...
public class SeedController {
                        ...
                        new SeedResponse(
                                ...
                                List.of(
                                        ...
                                        new UserCredentials(
                                                viewerUser.getEmail(),
                                                "viewer123",
                                                viewerUser.getRolesSet())))));
    }

    @PostMapping("/additional-tenant")
    @Operation(
            summary = "Seed Additional Tenant",
            description = "Create an additional tenant for multi-tenant testing")
    @Transactional
    ...
    public record SeedResponse(String message, String tenantId, List<UserCredentials> users) {}

    public record UserCredentials(String email, String password, Set<String> roles) {}
}
