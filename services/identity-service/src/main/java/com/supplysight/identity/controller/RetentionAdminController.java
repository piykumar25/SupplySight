...
public class RetentionAdminController {
    ...
    public RetentionAdminController(
            RetentionPolicyRepository policyRepository, DataPurgeService purgeService) {
    ...
    @Operation(
            ...
            description = "Get data retention policy for a tenant")
                        ...
                        .orElseThrow(
                                () ->
                                        new RuntimeException(
                                                "Retention policy not found for tenant"));
    ...
    @Operation(
            ...
            description = "Update data retention policy for a tenant")
    ...
    @Operation(
            summary = "Trigger Manual Purge",
            description = "Manually trigger data purge for a tenant")
    ...
    @Operation(
            summary = "Delete Tenant Data (GDPR)",
            description = "Permanently delete all data for a tenant")
    public ResponseEntity<ApiResponse<String>> deleteTenantData(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("All tenant data has been permanently deleted"));
    }
