...
public class LoggingConfig {
     ...
     * In development, use console logging with correlation ID.
     */
    @Bean
    ...
    public PatternLayout patternLayout() {
        ...
        layout.setPattern("%d{yyyy-MM-dd HH:mm:ss.SSS} [%thread] %-5level [%X{correlationId}] [%X{tenantId}] %logger{36} - %msg%n");
        return layout;
    }
}
