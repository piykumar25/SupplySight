...
/**
 * Core tracking event schema for supply chain visibility. Used across all services for event-driven
 * communication.
 */
...
public record TrackingEvent(
        ...
        @NotBlank(message = "eventType is required") @Size(max = 50) String eventType,
    ...
    public record Location(Double lat, Double lon, @Size(max = 50) String hubCode) {}

    /** Metadata for event traceability and auditing. */
    public record EventMetadata(
            Instant ingestedAt, UUID correlationId, String sourceIp, String userAgent) {}
