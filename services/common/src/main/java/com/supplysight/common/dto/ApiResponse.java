...
public record ApiResponse<T>(
        boolean success, T data, ErrorDetails error, Instant timestamp, String correlationId) {
    ...
    public static <T> ApiResponse<T> error(String code, String message) {
        return new ApiResponse<>(
                false, null, new ErrorDetails(code, message, null), Instant.now(), null);
    }

    public static <T> ApiResponse<T> error(String code, String message, String correlationId) {
        return new ApiResponse<>(
                false, null, new ErrorDetails(code, message, null), Instant.now(), correlationId);
    }
    ...
    public record ErrorDetails(
            String code, String message, java.util.Map<String, String> fieldErrors) {}
}
