...
public interface AuditLogRepository extends JpaRepository<AuditLog, Long> {
    ...
    Page<AuditLog> findByTenantIdAndUserIdOrderByEventTimeDesc(UUID tenantId, UUID userId, Pageable pageable);

    Page<AuditLog> findByTenantIdAndActionOrderByEventTimeDesc(UUID tenantId, String action, Pageable pageable);
