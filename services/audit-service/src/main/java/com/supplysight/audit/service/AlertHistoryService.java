...
public class AlertHistoryService {
     ...
     */
    public PageResponse<AlertHistoryDto.Response> getAlertHistory(UUID tenantId, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<AlertHistory> alerts = alertHistoryRepository.findByTenantIdOrderByCreatedAtDesc(tenantId, pageable);
    ...
    public PageResponse<AlertHistoryDto.Response> getAlertsByStatus(
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<AlertHistory> alerts = alertHistoryRepository.findByTenantIdAndStatusOrderByCreatedAtDesc(
    ...
    public List<AlertHistoryDto.Response> getOpenAlerts(UUID tenantId) {
        List<AlertHistory> openAlerts = alertHistoryRepository.findOpenAlerts(
                tenantId, List.of("OPEN", "ACKNOWLEDGED"));
    ...
    public PageResponse<AlertHistoryDto.Response> getAlertsByShipment(
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<AlertHistory> alerts = alertHistoryRepository.findByTenantIdAndShipmentIdOrderByCreatedAtDesc(
    ...
    private PageResponse<AlertHistoryDto.Response> mapToPageResponse(Page<AlertHistory> page) {
        List<AlertHistoryDto.Response> content = page.getContent().stream()
                .map(this::mapToResponse)
                .collect(Collectors.toList());

        return PageResponse.<AlertHistoryDto.Response>builder()
                .content(content)
                .page(page.getNumber())
                .size(page.getSize())
