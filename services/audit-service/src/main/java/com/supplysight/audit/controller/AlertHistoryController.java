...
public class AlertHistoryController {
    ...
    @Operation(
            ...
            description = "Get paginated alert history for the tenant")
    public ResponseEntity<ApiResponse<PageResponse<AlertHistoryDto.Response>>> getAlertHistory(
        ...
        PageResponse<AlertHistoryDto.Response> response =
                alertHistoryService.getAlertHistory(tenantId, page, size);
    ...
    public ResponseEntity<ApiResponse<PageResponse<AlertHistoryDto.Response>>> getAlertsByStatus(
        ...
        PageResponse<AlertHistoryDto.Response> response =
                alertHistoryService.getAlertsByStatus(tenantId, status, page, size);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    @Operation(
            summary = "Get alerts by shipment",
            description = "Get alert history for a specific shipment")
    public ResponseEntity<ApiResponse<PageResponse<AlertHistoryDto.Response>>> getAlertsByShipment(
        ...
        PageResponse<AlertHistoryDto.Response> response =
                alertHistoryService.getAlertsByShipment(tenantId, shipmentId, page, size);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<AlertHistoryDto.Response>> acknowledgeAlert(
        ...
        UUID userId =
                TenantContext.getCurrentTenantInfo()
