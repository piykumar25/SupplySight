...
public class AuditController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<AuditLogDto.Response>>> getAuditLogs(
        ...
        UUID tenantId =
                TenantContext.getCurrentTenant()
                        .orElseThrow(
                                () -> new IllegalStateException("Tenant context not available"));

        PageResponse<AuditLogDto.Response> response =
                auditQueryService.getAuditLogs(tenantId, page, size);
    ...
    public ResponseEntity<ApiResponse<PageResponse<AuditLogDto.Response>>> getAuditLogsByUser(
        ...
        PageResponse<AuditLogDto.Response> response =
                auditQueryService.getAuditLogsByUser(tenantId, userId, page, size);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<AuditLogDto.Response>>> getAuditLogsByResource(
        ...
        PageResponse<AuditLogDto.Response> response =
                auditQueryService.getAuditLogsByResource(
    ...
    @Operation(
            summary = "Get log by correlation ID",
            description = "Get audit log by correlation ID")
    ...
    @Operation(
            ...
            description = "Get audit summary statistics for the tenant")
    ...
    public ResponseEntity<ApiResponse<AuditLogDto.ComplianceReport>> getComplianceReport(
        ...
        AuditLogDto.ComplianceReport report =
                auditQueryService.generateComplianceReport(tenantId, startDate, endDate);
    ...
    @Operation(
            ...
            description = "Get daily audit statistics for a date range")
    public ResponseEntity<ApiResponse<List<AuditLogDto.DailyStats>>> getDailyStats(
        ...
        List<AuditLogDto.DailyStats> stats =
                auditQueryService.getDailyStats(tenantId, startDate, endDate);
