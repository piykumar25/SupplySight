...
/**
 * REST controller for shipment visibility APIs.
 * Provides low-latency read access to shipment state and timeline.
 */
@RestController
...
public class ShipmentController {
    ...
    @Operation(summary = "Get Shipment Current State", description = "Get the current state of a shipment with low latency")
    ...
    @Operation(summary = "Get Shipment Timeline", description = "Get the complete event timeline for a shipment, sorted by event time")
    ...
    @GetMapping
    @Operation(summary = "List Shipments", description = "List all shipments with pagination and optional filtering")
    public ResponseEntity<ApiResponse<PageResponse<ShipmentSummary>>> listShipments(
        ...
        ShipmentQuery query = new ShipmentQuery(status, fromDate, toDate, page, size, sortBy, sortDir);
    ...
    @GetMapping("/active")
    @Operation(summary = "Get Active Shipments", description = "Get all currently active (in-transit) shipments")
    ...
    @Operation(summary = "Get Dashboard Statistics", description = "Get aggregated statistics for the dashboard")
