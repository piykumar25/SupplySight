...
/** Automatically seeds demo shipments on application startup. Runs only if data is missing. */
@Component
@Profile("!prod")
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<ShipmentCurrentState> shipments =
                Arrays.asList(
                        createShipment(
                                SHIPMENT_ID_1,
                                "IN_TRANSIT",
    ...
    private ShipmentCurrentState createShipment(
            UUID id,
            String status,
